...
Milestone 0001's first illustrative subtask (`01-config-model.md` in the removed
...
- `HealthConfig` (`01-config-model.md` in the removed template roadmap example)
...
- **Roadmap task:** `01-config-model.md` from the removed template roadmap example - the first (and, at this milestone, only) consumer.
