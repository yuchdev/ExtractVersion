# Extract Version Roadmap

Planning and progress tracking for Extract Version, organised as a three-tier
...
```
[docs/roadmap/0001-working-implementation/plan.md](/docs/roadmap/0001-working-implementation/plan.md)
```
